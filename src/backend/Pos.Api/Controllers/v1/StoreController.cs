...
public class StoreController : ControllerBase
{
    ...
    {
        var categoriesResult = await _catalogService.GetCategoriesAsync(null, cancellationToken, page: 1, pageSize: 100);
        var activeCategories = categoriesResult.Items.Where(c => c.IsActive).ToList();
